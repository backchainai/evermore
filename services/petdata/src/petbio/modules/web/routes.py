...
from petbio.modules.db.models import Animal  # noqa: TC001
from petbio.modules.web.dependencies import get_db
from petbio.modules.web.schemas import (
...
if TYPE_CHECKING:
    from petbio.modules.db import Database
