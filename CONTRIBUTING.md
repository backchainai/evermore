...
Per-module build and test commands live in each module's own `CLAUDE.md`, and the platform tech-stack standard governs all modules. See `docs/evermore-vision-and-architecture.md` for product and architecture, and `docs/plans/repo-restructure-and-rename.md` for current state and sequencing.
