...
tags:
  ...
  - security
supersedes: null
superseded_by: docs/adr/0030-per-service-supabase-projects.md
related: [3]
---

# 007: Authentication Strategy

> Migrated from retriever/decisions/007-authentication-strategy.md (originally #007, 2024-12-18).

## Status

Superseded by ADR 0030 (`0030-per-service-supabase-projects.md`): Evermore's single-sign-on identity project (`evermore-auth`, Supabase Auth) issues the JWTs every module verifies, replacing this record's standalone email/password JWT scheme.
