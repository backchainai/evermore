...
tags:
  ...
  - opentelemetry
supersedes: 8
superseded_by: "evermore platform ADR 0027"
related: [8, 10]
---

# 018: GCP Native Observability

> Migrated from retriever/decisions/018-gcp-native-observability.md (originally #018, 2026-03-13).

## Status

Superseded by evermore platform ADR 0027 (`docs/adr/0027-datadog-via-otel-collector.md`), which moves the telemetry backend to Datadog via the OpenTelemetry Collector under the ADR 0003 conformance mandate. This ADR supersedes [ADR-008](0008-observability-stack.md).
