...
> Migrated from retriever/decisions/010-resilience-patterns.md (originally #010, 2024-12-18).
...
3. **Model fallback**: Sonnet → Haiku chain (see [ADR-002](0002-llm-provider-strategy.md))
