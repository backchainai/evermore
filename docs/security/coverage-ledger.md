...
| `.github/workflows/claude-code-review.yml` | security-critical | line-by-line | FINDING #268 (High): unpinned runtime plugin marketplace + fork-PR author gate commented out; fork-PR secret withholding bounds denial-of-wallet (#224 C1) |
